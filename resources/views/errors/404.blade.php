...
<!-- Mirrored from 192.185.228.226/projects/ma/1-5-1/jquery/404.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 11 Sep 2015 11:46:33 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="four-zero-content">        
        <div class="four-zero">
            ...
            <footer>
                <a href="/admin/dashboard"><i class="zmdi zmdi-arrow-back"></i></a>
                <a href="/admin/dashboard"><i class="zmdi zmdi-home"></i></a>
            </footer>
        </div>
